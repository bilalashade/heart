...
<br>
<br>
<form ACTION="member_pro.php" method="POST" name="form1" id="form1">
  <table align="center">
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Username:</td>
      <td><span id="sprytextfield1">
        <input name="username" type="text" value="" size="20" maxlength="20" required />
      </span></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Password:</td>
      <td><span id="sprytextfield2">
        <input name="password" type="password" value="" size="20" maxlength="20" required />
      </span></td>
    </tr>
   
  </table>
  <br>
  <input type="submit" class="art-button"  name="submit" value="Login" />
</form></center>
