...
_animations.htm</span></div>
    </div><div class="art-layout-cell layout-item-2" style="width: 60%" ><p  class="a style">
...
<tr>
 <td colspan="2" style="text-align:center">
  <input type="submit" value="Submit">   <a href="http://localhost/heart/index.php">Email Form</a>
 </td>
</tr>
</table>
</form>
