...
_animations.htm</span></div>
	...
	<iframe id='ifrmPrint' src='#' style="width:0px; height:0px;"></iframe>
		<div id="divToPrint"><p class="a" ><?php echo "Dear  ".$row_re['surname']; ?>
&nbsp;
...
<table width="591" height="55" border="0">
  ...
  <?php do { ?>
    ...
    <?php } while ($row_bs = mysql_fetch_assoc($bs)); ?>
		...
		<center>
		<input type="button" name="button" value="PRINT REPORT" onClick="ClickHereToPrint()"/>
		</center>
</center>
...
function ClickHereToPrint(){
    try{ 
		...
		oDoc.write("<title>Patient Report</title><link href='css/css2.css' rel='stylesheet' type='text/css'/></head><table width='610px'><tr><td width='110px' align='left'><img src='hat.png' width='100px' height='80px'></td><td width='500px' valign='top'>HEART DISEASE PREDICTION SYSTEM<br>Universiti Sultan Zainal Abidin<br>Individual Report> </td></tr></table><br><body onload='this.focus(); this.print();'>");
