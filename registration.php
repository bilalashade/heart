...
<center><form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="othername" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td><input type="email" name="email" value="" size="32" required /></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td><input name="password" type="password" value="" size="32" required /></td>
    </tr>
  </table>
  
  <br>
  <input type="submit" class="art-button" value="Register" />
