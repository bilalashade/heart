...
s   <li><a href="registration.php">Registration</a></li>
...
<center><form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center">
		...
		<center>
		<input type="button" name="button" value="PRINT" onClick="ClickHereToPrint()"/>
		</center>
...
function ClickHereToPrint(){
    try{ 
		...
		oDoc.write("<title>Laporan Lengkap Cuti Pekerja</title><link href='css/css2.css' rel='stylesheet' type='text/css'/></head><table width='610px'><tr><td width='110px' align='left'><img src='image.jpg' width='100px' height='80px'></td><td width='500px' valign='top'>SISTEM PENGURUSAN ASET FAKULTI<br>Universiti Sultan Zainal Abidin<br>Laporan Pembekal> aset</td></tr></table><br><body onload='this.focus(); this.print();'>");
