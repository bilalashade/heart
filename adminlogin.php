...
if (isset($_POST['username'])) {
  ...
  if ($loginFoundUser) {
   ...
   // header("Location: ". $MM_redirectLoginFailed );
	echo "<script> alert('Log in details are not correct')</script>";
...
<form ACTION="<?php echo $loginFormAction; ?>" method="POST" name="form1" id="form1">
  <table align="center">
    <tr valign="baseline">
      ...
      <td><input name="username" type="text" value="" size="20" maxlength="20" required /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Password:</td>
      <td><input name="password" type="password" value="" size="20" maxlength="20" required /></td>
    </tr>
    <tr valign="baseline">
