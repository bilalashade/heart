...
mysql_select_db("heartdiseasedignosis");
...
$_SESSION['password'] = $_POST['password'];
	if($username != '') {
		...
		$_SESSION['uname'] = "<script>alert('The Username or Password is not found')</script> <a href='userlogin.php'>Click Here to Try Again</a>";
